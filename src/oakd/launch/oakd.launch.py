...
#############################
# taken from https://github.com/ros-navigation/navigation2/blob/main/nav2_common/nav2_common/launch/rewritten_yaml.py
# how to import this cleanly?
#############################
...
def generate_launch_description():
    ...
    ARGUMENTS = [
        ...
        DeclareLaunchArgument('params_file', default_value=[PathJoinSubstitution([pkg_oakd, 'config', 'oakd_pro']), '.yaml']),
